...
import TheBanner1Vue from './components/TheBanner1.vue';
import TheBanner2Vue from './components/TheBanner2.vue';
import TheFooterVue from './components/TheFooter.vue';
import Themaincontent from './components/Themaincontent.vue';

export default {
  components: { TheBanner1Vue, TheBanner2Vue, TheNavbarVue, TheFooterVue,Themaincontent },
  data(){
    return{
      fumettiList:[
  {
...
<template>
  ...
  <div class="main-content">
    <Themaincontent :fumettiList="fumettiList"></Themaincontent>
